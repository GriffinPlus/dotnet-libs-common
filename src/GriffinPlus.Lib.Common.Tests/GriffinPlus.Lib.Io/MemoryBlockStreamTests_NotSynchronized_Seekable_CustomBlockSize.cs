...
namespace GriffinPlus.Lib.Io
{
	...
	/// </summary>
	public class MemoryBlockStreamTests_NotSynchronized_Seekable_CustomBlockSize : MemoryBlockStreamTestsBase_Seekable
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MemoryBlockStreamTests_NotSynchronized_Seekable_CustomBlockSize"/> class.
		/// </summary>
		public MemoryBlockStreamTests_NotSynchronized_Seekable_CustomBlockSize() : base(false, false)
		{
		}
