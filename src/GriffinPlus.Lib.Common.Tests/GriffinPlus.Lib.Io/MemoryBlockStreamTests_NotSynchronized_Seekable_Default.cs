...
namespace GriffinPlus.Lib.Io
{
	...
	/// </summary>
	public class MemoryBlockStreamTests_NotSynchronized_Seekable_Default : MemoryBlockStreamTestsBase_Seekable
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MemoryBlockStreamTests_NotSynchronized_Seekable_Default"/> class.
		/// </summary>
		public MemoryBlockStreamTests_NotSynchronized_Seekable_Default() : base(false, false)
		{
		}
