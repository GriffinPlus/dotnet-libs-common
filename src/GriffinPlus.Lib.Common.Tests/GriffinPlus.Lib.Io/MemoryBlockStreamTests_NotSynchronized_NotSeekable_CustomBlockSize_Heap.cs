...
namespace GriffinPlus.Lib.Io
{
	...
	/// </summary>
	public class MemoryBlockStreamTests_NotSynchronized_NotSeekable_CustomBlockSize_Heap : MemoryBlockStreamTestsBase_NotSeekable
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MemoryBlockStreamTests_NotSynchronized_NotSeekable_CustomBlockSize_Heap"/> class.
		/// </summary>
		public MemoryBlockStreamTests_NotSynchronized_NotSeekable_CustomBlockSize_Heap() : base(false, false)
		{
		}
		...
		protected override MemoryBlockStream CreateStreamToTest(int minimumBlockSize = -1)
		{
			...
			return new MemoryBlockStream(false, minimumBlockSize, null, true);
		}
	}
