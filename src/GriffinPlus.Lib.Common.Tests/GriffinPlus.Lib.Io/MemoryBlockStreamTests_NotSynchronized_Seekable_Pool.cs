...
namespace GriffinPlus.Lib.Io
{
	...
	/// </summary>
	public class MemoryBlockStreamTests_NotSynchronized_Seekable_Pool : MemoryBlockStreamTestsBase_Seekable
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MemoryBlockStreamTests_NotSynchronized_Seekable_Pool"/> class.
		/// </summary>
		public MemoryBlockStreamTests_NotSynchronized_Seekable_Pool() : base(false, true)
		{
		}
