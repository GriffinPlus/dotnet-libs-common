...
namespace GriffinPlus.Lib.Configuration
{
	...
	public abstract class CascadedConfigurationTests
	{
		...
		protected virtual ICascadedConfigurationPersistenceStrategy GetStrategy() => null;
		...
		private void SetItem_CheckCreatedItemCommon(
			...
			Type                       expectedItemValueType)
		{
			...
			string itemName = item.Path.Substring(item.Path.LastIndexOf('/') + 1);
		...
		/// <param name="expectedItemValueType">The expected item value type.</param>
		private void SetItem_CheckCreatedItemsCommon(
			CascadedConfiguration rootConfiguration,
			string[]              itemPaths,
			Type                  expectedItemValueType)
		{
		...
		private void SetValue_CheckCreatedItemCommon(
			CascadedConfiguration      rootConfiguration,
			ICascadedConfigurationItem item,
			Type                       expectedItemValueType,
		...
		/// <param name="expectedItemValueType">The expected item value type.</param>
		/// <param name="expectedItemValue">The expected item value.</param>
		private void SetValue_CheckCreatedItemsCommon(
			CascadedConfiguration rootConfiguration,
			string[]              itemPaths,
			Type                  expectedItemValueType,
			object                expectedItemValue)
		...
		/// <summary>
		/// Recursively collects all child configurations of the specified configuration.
		/// </summary>
		/// <param name="configuration">Configuration from which to collect the child configurations.</param>
		/// <returns>All child configurations of the specified configuration.</returns>
		private static List<CascadedConfiguration> CollectAllChildConfigurations(CascadedConfiguration configuration)
		{
		...
		private static List<ICascadedConfigurationItem> CollectAllItemsInConfiguration(CascadedConfiguration configuration)
		{
		...
		private static List<string> CollectElementPaths(CascadedConfiguration configuration)
		{
