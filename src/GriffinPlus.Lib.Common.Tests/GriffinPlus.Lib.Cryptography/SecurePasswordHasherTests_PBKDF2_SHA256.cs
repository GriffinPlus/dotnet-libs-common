...
namespace GriffinPlus.Lib.Cryptography
{
	...
	public class SecurePasswordHasherTests_PBKDF2_SHA256 : SecurePasswordHasherTests_Base
	{
		...
		/// </summary>
		protected override Regex PasswordHashRegex { get; } = new(@"^\$PBKDF2-SHA256\$(?<iterations>\d+)\$(?<hash>[a-zA-Z0-9+/=]{64})$", RegexOptions.Compiled);
		...
		public static IEnumerable<object[]> TestData_Verify_TooLessFields
		{
			get
			{
				yield return [""];
				yield return ["$"];
				yield return ["$PBKDF2-SHA256$"];
				yield return ["$PBKDF2-SHA256$10000"];
			}
		}
		...
		{
			get { yield return ["$PBKDF2-SHA256$x$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="]; }
		}
		...
		public static IEnumerable<object[]> TestData_Verify_HashSizeTooShortOrToLong
		{
			get
			{
				yield return ["$PBKDF2-SHA256$10000$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=="];
				yield return ["$PBKDF2-SHA256$10000$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"];
			}
		}
		...
		{
			get { yield return ["$PBKDF2-SHA256$10000$============================================================================================================"]; }
		}
