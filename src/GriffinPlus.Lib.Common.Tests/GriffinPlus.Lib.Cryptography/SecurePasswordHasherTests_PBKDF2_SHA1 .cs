...
public class SecurePasswordHasherTests_PBKDF2_SHA1 : SecurePasswordHasherTests_Base
{
	...
	{
		return SecurePasswordHasher.PBKDF2_SHA1;
	}
	...
	/// </summary>
	protected override Regex PasswordHashRegex { get; } = new(@"^\$PBKDF2-SHA1\$(?<iterations>\d+)\$(?<hash>[a-zA-Z0-9+/=]{48})$", RegexOptions.Compiled);
	...
	public static IEnumerable<object[]> TestData_Verify_TooLessFields
	{
		get
		{
			yield return [""];
			yield return ["$"];
			yield return ["$PBKDF2-SHA1$"];
			yield return ["$PBKDF2-SHA1$10000"];
		}
	}
	...
	{
		get { yield return ["$PBKDF2-SHA1$x$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="]; }
	}
	...
	public static IEnumerable<object[]> TestData_Verify_HashSizeTooShortOrToLong
	{
		get
		{
			yield return ["$PBKDF2-SHA1$10000$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=="];
			yield return ["$PBKDF2-SHA1$10000$AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"];
		}
	}
	...
	{
		get { yield return ["$PBKDF2-SHA1$10000$============================================================================================================"]; }
	}
