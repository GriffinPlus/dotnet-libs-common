...
namespace GriffinPlus.Lib.Cryptography
{
	...
	/// <summary>
	/// Tests targeting the <see cref="SecurePasswordHasher_SHA384"/> class.
	/// </summary>
	public class SecurePasswordHasherTests_SHA384 : SecurePasswordHasherTests_Base
	{
		/// <summary>
		/// Gets the <see cref="SecurePasswordHasher_SHA384"/> instance to test.
		/// </summary>
		/// <returns></returns>
		protected override SecurePasswordHasher GetHasher() => SecurePasswordHasher.SHA384;
		...
		/// </summary>
		protected override int HashSize => 48;
		...
		#region bool SecurePasswordHasher_SHA384.Verify(string password, string passwordHash)
		...
		#region bool SecurePasswordHasher_SHA384.Verify(ReadOnlySpan<char> password, ReadOnlySpan<char> passwordHash)
