...
namespace GriffinPlus.Lib.Imaging
{
	...
	public readonly struct PixelFormat : IEquatable<PixelFormat>
	{
		...
		/// otherwise <c>false</c>.
		/// </returns>
		public static bool operator ==(PixelFormat left, PixelFormat right) => Equals(left, right);
		...
		/// otherwise <c>false</c>.
		/// </returns>
		public static bool Equals(PixelFormat pixelFormat1, PixelFormat pixelFormat2) => pixelFormat1.FormatEnum == pixelFormat2.FormatEnum;
		...
		/// otherwise <c>false</c>.
		/// </returns>
		public bool Equals(PixelFormat pixelFormat) => Equals(this, pixelFormat);
		...
		/// otherwise <c>false</c>.
		/// </returns>
		public override bool Equals(object obj) => obj is PixelFormat pixelFormat && Equals(this, pixelFormat);

		/// <summary>
		/// Gets the hash code of the <see cref="PixelFormat"/> instance.
		/// </summary>
		/// <returns>The pixel format's hash code.</returns>
		public override int GetHashCode() => FormatEnum.GetHashCode();
