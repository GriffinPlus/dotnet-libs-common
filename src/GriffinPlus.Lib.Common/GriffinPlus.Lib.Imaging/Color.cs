...
public partial struct Color : IFormattable, IEquatable<Color>
{
	...
	{
		return mScRgbColor.GetHashCode();
	}
	...
	{
		return ConvertToString(mIsFromScRgb ? "R" : null, null);
	}
	...
	{
		return ConvertToString(mIsFromScRgb ? "R" : null, provider);
	}
	...
	public static bool operator ==(Color left, Color right)
	{
		...
		return left.mScRgbColor.R == right.mScRgbColor.R &&
