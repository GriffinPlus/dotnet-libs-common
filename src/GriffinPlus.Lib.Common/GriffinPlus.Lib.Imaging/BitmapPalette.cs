...
public sealed class BitmapPalette : IEquatable<BitmapPalette>
{
	...
	/// otherwise <c>false</c>.
	/// </returns>
	public static bool operator ==(BitmapPalette left, BitmapPalette right)
	{
	...
	/// otherwise <c>false</c>.
	/// </returns>
	public bool Equals(BitmapPalette other)
	{
	...
	{
		return obj is BitmapPalette palette && Equals(this, palette);
	}
	...
	public override int GetHashCode()
	{
		...
		{
			int hashCode = 0;
			int count = mColors.Count;
			for (int i = 0; i < count; i++) hashCode = (hashCode * 397) ^ mColors[i].GetHashCode();
			return hashCode;
		}
	}
