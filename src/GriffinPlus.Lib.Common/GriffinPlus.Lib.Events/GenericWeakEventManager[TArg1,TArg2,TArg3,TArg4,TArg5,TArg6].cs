...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
{
		...
		TArg6                                            arg6)
	{
		...
		else
		{
			if (scheduleAlways)
			{
				while (!ThreadPool.QueueUserWorkItem(_ => handler(arg1, arg2, arg3, arg4, arg5, arg6)))
				{
					Thread.Sleep(50);
				}
			}
		...
		TArg6  arg6)
	{
		...
		foreach (Item item in items)
		{
			...
			else
			{
				...
				{
					while (!ThreadPool.QueueUserWorkItem(_ => item.Fire(arg1, arg2, arg3, arg4, arg5, arg6)))
					{
						Thread.Sleep(50);
					}
				}
		...
		foreach (Item item in items)
		{
			...
			else
			{
					...
					arg6) =>
				{
					...
					{
						while (!ThreadPool.QueueUserWorkItem(_ => itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6)))
						{
							Thread.Sleep(50);
						}
					}
					...
					{
						itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6);
					}
				};
			}
		}
