...
/// <see cref="Action{TArg1,TArg2,TArg3,TArg4,TArg5,TArg6}"/>).
/// <br/>
...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
{
		...
		TArg6                                            arg6)
	{
		...
		if (context != null)
		{
			if (scheduleAlways) context.Post(_ => handler(arg1, arg2, arg3, arg4, arg5, arg6), null);
			else handler(arg1, arg2, arg3, arg4, arg5, arg6);
		}
		else
		{
			if (scheduleAlways) Task.Run(() => handler(arg1, arg2, arg3, arg4, arg5, arg6));
			else handler(arg1, arg2, arg3, arg4, arg5, arg6);
		}
		...
		TArg6  arg6)
	{
		...
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
				...
				{
					item.Fire(arg1, arg2, arg3, arg4, arg5, arg6);
				}
				else
				{
					item.SynchronizationContext.Post(x => { ((Item)x!).Fire(arg1, arg2, arg3, arg4, arg5, arg6); }, item);
				}
			}
			else
			{
				...
				if (item.ScheduleAlways) Task.Run(() => item.Fire(arg1, arg2, arg3, arg4, arg5, arg6));
				else item.Fire(arg1, arg2, arg3, arg4, arg5, arg6);
			}
		}
	}
	...
	public static Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> GetEventCallers(object obj, string eventName)
	{
		Item[] items;
		...
		Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> handlers = null;
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
			...
			else
			{
				...
				handlers += (
					...
					arg6) =>
				{
					if (itemCopy.ScheduleAlways) Task.Run(() => itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6));
					else itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6);
				};
			}
		}
