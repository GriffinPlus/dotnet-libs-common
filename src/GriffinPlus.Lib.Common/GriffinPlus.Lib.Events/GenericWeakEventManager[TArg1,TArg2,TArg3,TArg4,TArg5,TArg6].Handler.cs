...
public partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
{
	/// <summary>
	...
	public class Handler
	{
		...
		public Handler(Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> handler)
		{
			...
			TArg6 arg6)
		{
			if (Target != null)
			{
				...
				Invoker(target, arg1, arg2, arg3, arg4, arg5, arg6);
				return true;
			}

			// event handler is a static method
			// => invoke event handler...
			Invoker(null, arg1, arg2, arg3, arg4, arg5, arg6);
			return true;
		}
	}
}
