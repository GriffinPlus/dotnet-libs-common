...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3>
{
		...
		bool                        scheduleAlways)
	{
		...
		public ItemMatchResult IsHandler(Action<TArg1, TArg2, TArg3> handler)
		{
		...
		public bool Fire(TArg1 arg1, TArg2 arg2, TArg3 arg3)
		{
			return mHandler.Invoke(arg1, arg2, arg3);
		}
	}
