...
/// <summary>
/// Event manager that administrates weak event handlers in a central place (for generic actions using <see cref="Action{TArg1,TArg2,TArg3,TArg4}"/>).
/// <br/>
...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4>
{
		...
		TArg4                              arg4)
	{
		...
		if (context != null)
		{
			if (scheduleAlways) context.Post(_ => handler(arg1, arg2, arg3, arg4), null);
			else handler(arg1, arg2, arg3, arg4);
		}
		else
		{
			if (scheduleAlways) Task.Run(() => handler(arg1, arg2, arg3, arg4));
			else handler(arg1, arg2, arg3, arg4);
		}
		...
		TArg4  arg4)
	{
		...
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
				...
				{
					item.Fire(arg1, arg2, arg3, arg4);
				}
				else
				{
					item.SynchronizationContext.Post(x => { ((Item)x!).Fire(arg1, arg2, arg3, arg4); }, item);
				}
			}
			else
			{
				...
				if (item.ScheduleAlways) Task.Run(() => item.Fire(arg1, arg2, arg3, arg4));
				else item.Fire(arg1, arg2, arg3, arg4);
			}
		}
	}
	...
	public static Action<TArg1, TArg2, TArg3, TArg4> GetEventCallers(object obj, string eventName)
	{
		Item[] items;
		...
		Action<TArg1, TArg2, TArg3, TArg4> handlers = null;
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
			...
			else
			{
				...
				handlers += (
					...
					arg4) =>
				{
					if (itemCopy.ScheduleAlways) Task.Run(() => itemCopy.Fire(arg1, arg2, arg3, arg4));
					else itemCopy.Fire(arg1, arg2, arg3, arg4);
				};
			}
		}
