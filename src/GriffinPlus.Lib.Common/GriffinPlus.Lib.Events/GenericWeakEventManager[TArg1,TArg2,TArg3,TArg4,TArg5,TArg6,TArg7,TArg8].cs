...
/// <see cref="Action{TArg1,TArg2,TArg3,TArg4,TArg5,TArg6,TArg7,TArg8}"/>).
/// <br/>
...
/// <typeparam name="TArg8">Type of the eighth argument passed to event handlers.</typeparam>
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8>
{
	...
	/// <param name="arg8">Eighth argument to pass to the event handler that is fired immediately.</param>
	/// <returns>Total number of registered event handlers (including the specified event handler).</returns>
	public static int RegisterEventHandler(
		object                                                         obj,
		string                                                         eventName,
		...
		TArg8                                                          arg8)
	{
		...
		if (context != null)
		{
			if (scheduleAlways) context.Post(_ => handler(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8), null);
			else handler(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		}
		else
		{
			if (scheduleAlways) Task.Run(() => handler(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
			else handler(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		}
	...
	/// <param name="arg8">Eighth argument to pass to invoked event handlers.</param>
		...
		TArg8  arg8)
	{
		...
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
				...
				{
					item.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
				}
				else
				{
					item.SynchronizationContext.Post(x => { ((Item)x!).Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); }, item);
				}
			}
			else
			{
				...
				if (item.ScheduleAlways) Task.Run(() => item.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
				else item.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
			}
		}
	}
	...
	public static Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8> GetEventCallers(object obj, string eventName)
	{
		Item[] items;
		...
		Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8> handlers = null;
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
			...
			else
			{
				...
				handlers += (
					...
					arg8) =>
				{
					if (itemCopy.ScheduleAlways) Task.Run(() => itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
					else itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
				};
			}
		}
