...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8>
{
		...
		TArg8                                                          arg8)
	{
		...
		else
		{
			if (scheduleAlways)
			{
				while (!ThreadPool.QueueUserWorkItem(_ => handler(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)))
				{
					Thread.Sleep(50);
				}
			}
		...
		TArg8  arg8)
	{
		...
		foreach (Item item in items)
		{
			...
			else
			{
				...
				{
					while (!ThreadPool.QueueUserWorkItem(_ => item.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)))
					{
						Thread.Sleep(50);
					}
				}
		...
		foreach (Item item in items)
		{
			...
			else
			{
					...
					arg8) =>
				{
					...
					{
						while (!ThreadPool.QueueUserWorkItem(_ => itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)))
						{
							Thread.Sleep(50);
						}
					}
					...
					{
						itemCopy.Fire(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
					}
				};
			}
		}
