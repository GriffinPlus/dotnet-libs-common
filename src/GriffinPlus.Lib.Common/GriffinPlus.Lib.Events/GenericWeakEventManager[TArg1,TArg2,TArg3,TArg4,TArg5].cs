...
/// <see cref="Action{TArg1,TArg2,TArg3,TArg4,TArg5}"/>).
/// <br/>
...
public static partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5>
{
		...
		TArg5                                     arg5)
	{
		...
		if (context != null)
		{
			if (scheduleAlways) context.Post(_ => handler(arg1, arg2, arg3, arg4, arg5), null);
			else handler(arg1, arg2, arg3, arg4, arg5);
		}
		else
		{
			if (scheduleAlways) Task.Run(() => handler(arg1, arg2, arg3, arg4, arg5));
			else handler(arg1, arg2, arg3, arg4, arg5);
		}
		...
		TArg5  arg5)
	{
		...
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
				...
				{
					item.Fire(arg1, arg2, arg3, arg4, arg5);
				}
				else
				{
					item.SynchronizationContext.Post(x => { ((Item)x!).Fire(arg1, arg2, arg3, arg4, arg5); }, item);
				}
			}
			else
			{
				...
				if (item.ScheduleAlways) Task.Run(() => item.Fire(arg1, arg2, arg3, arg4, arg5));
				else item.Fire(arg1, arg2, arg3, arg4, arg5);
			}
		}
	}
	...
	public static Action<TArg1, TArg2, TArg3, TArg4, TArg5> GetEventCallers(object obj, string eventName)
	{
		Item[] items;
		...
		Action<TArg1, TArg2, TArg3, TArg4, TArg5> handlers = null;
		foreach (Item item in items)
		{
			if (item.SynchronizationContext != null)
			{
			...
			else
			{
				...
				handlers += (
					...
					arg5) =>
				{
					if (itemCopy.ScheduleAlways) Task.Run(() => itemCopy.Fire(arg1, arg2, arg3, arg4, arg5));
					else itemCopy.Fire(arg1, arg2, arg3, arg4, arg5);
				};
			}
		}
