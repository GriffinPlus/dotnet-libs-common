...
public partial class GenericWeakEventManager<TArg1, TArg2, TArg3>
{
	/// <summary>
	...
	public class Handler
	{
		...
		public Handler(Action<TArg1, TArg2, TArg3> handler)
		{
		...
		/// </returns>
		public bool Invoke(TArg1 arg1, TArg2 arg2, TArg3 arg3)
		{
			if (Target != null)
			{
				...
				Invoker(target, arg1, arg2, arg3);
				return true;
			}

			// event handler is a static method
			// => invoke event handler...
			Invoker(null, arg1, arg2, arg3);
			return true;
		}
	}
}
