...
public partial class GenericWeakEventManager<TArg1, TArg2, TArg3, TArg4, TArg5>
{
	/// <summary>
	...
	public class Handler
	{
		...
		public Handler(Action<TArg1, TArg2, TArg3, TArg4, TArg5> handler)
		{
			...
			TArg5 arg5)
		{
			if (Target != null)
			{
				...
				Invoker(target, arg1, arg2, arg3, arg4, arg5);
				return true;
			}

			// event handler is a static method
			// => invoke event handler...
			Invoker(null, arg1, arg2, arg3, arg4, arg5);
			return true;
		}
	}
}
