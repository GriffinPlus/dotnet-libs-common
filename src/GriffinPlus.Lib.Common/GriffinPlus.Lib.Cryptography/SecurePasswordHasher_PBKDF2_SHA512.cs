...
namespace GriffinPlus.Lib.Cryptography
{
	...
	/// The hash algorithm used to derive the key is SHA-512 (64 bytes hash).
	/// It uses 16 bytes salt when hashing.
	/// </summary>
	sealed class SecurePasswordHasher_PBKDF2_SHA512 : SecurePasswordHasher
	{
		/// <summary>
		...
		/// </summary>
		internal const string AlgorithmNameDefinition = "PBKDF2-SHA512";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SecurePasswordHasher_PBKDF2_SHA512"/> class.
		/// </summary>
		public SecurePasswordHasher_PBKDF2_SHA512() { }
...
#elif NETSTANDARD2_1 || NET48 || NETCOREAPP3_1 || NET5_0
			byte[] salt;
