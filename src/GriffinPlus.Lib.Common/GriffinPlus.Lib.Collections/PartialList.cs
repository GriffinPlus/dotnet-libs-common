...
namespace GriffinPlus.Lib.Collections
{
	...
	/// <summary>
	/// A read-only subset of another collection implementing the <see cref="IList"/> interface.
	/// </summary>
	[DebuggerDisplay("Count = {Count})]")]
	[DebuggerTypeProxy(typeof(DebugView))]
	public sealed class PartialList : IList
	{
		private readonly int   mInitialOffset;
		private readonly IList mList;

		/// <summary>
		/// Initializes a new instance of the <see cref="PartialList"/> class taking an entire specified list
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PartialList"/> class providing a subset of the specified list
		...
		public PartialList(IList list, int offset, int count)
		{
